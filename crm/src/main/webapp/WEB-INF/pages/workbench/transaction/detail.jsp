        ...
        <div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small
                    style="color: gray;"> ${remark.editFlag=='0'?remark.createTime:remark.editTime} ${remark.editFlag=='0'?remark.createBy:remark.editBy} ${remark.editFlag=='0'?'创建':'修改'}</small>
