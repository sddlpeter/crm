...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="5edbb7a3a0d24a6a8e30ab0bfdb32b5c">
				<input type="text" class="form-control" id="create-activityName" value="市场活动05_01">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="c517ccc909694d53b136a314224649c6">
